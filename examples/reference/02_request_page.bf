...
# Full implementation: bf/phase3_page1_parser.bf (gen_phase3_bf.py)
#
# Protocol:
#   (1) Send "H\n" -> read 200 hex chars + newline
#   (2) Send "R 4096 1\n" -> read 8192 hex chars + newline
#
# Run the built phase3: INSPECTOR=./phase3_page1_parser ./scripts/run_inspector.sh tests/fixtures/tiny.db
